    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col min-h-screen">
      ...
      <div className="px-6 py-8 border-b border-gray-200">
        ...
        <div className="bg-gray-50 rounded-xl border border-gray-100 p-4">
          ...
          {plan && (
            <span className="inline-block mt-3 px-3 py-1.5 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full capitalize">
              {plan} Plan
            </span>
          )}
        </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <button
          ...
          className="w-full px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-lg transition-all duration-200 border border-gray-200"
        >
          Sign Out
        </button>
      </div>
